...
import me.zeroeightsix.kami.util.HwidStuff;
...
public class KamiMod {
    ...
    public static final String MODID = "apollyon";
    public static final String MODNAME = "Apollyon";
    public static final String MODVER = "b16";
    ...
    private static final String KAMI_CONFIG_NAME_DEFAULT = "ApollyonConfig.json";

    public static final Logger log = LogManager.getLogger("Apollyon");
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	HwidStuff.initValidHwids();
    	try {
    	 if(!HwidStuff.getValidHwids().contains(HwidStuff.getHWID())) {
    	  InvalidHwidWindow ihw = new InvalidHwidWindow();
    	  KamiMod.log.info("Invalid hwid!\n");
       	  ihw.setVisible(false);
          System.exit(0);
    	 }    	
    	} catch(NoSuchAlgorithmException e) {
    		System.err.println(e.toString());
    		KamiMod.log.info("caught NoSuchAlgorithmException while checking hwid: " + e.getMessage() + "\n");
    		System.exit(1);
    	}
    	catch(UnsupportedEncodingException ex) {
    		System.err.println(ex.toString());
            KamiMod.log.info("caught UnsupportedEncodingException while checking hwid: " + ex.getMessage() + "\n");
    		System.exit(1);
    	}

    	KamiMod.log.info("Hwid is valid!\n");
    ...
    public void postInit(FMLPostInitializationEvent event) {
         ...
         KamiMod.log.info("Started Discord RPC\n");

        KamiMod.log.info(MODNAME + " initialized!\n");
    ...
    public static String getConfigName() {
        Path config = Paths.get("ApollyonLastConfig.txt");
