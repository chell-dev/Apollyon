...
public class KamiFrameUI<T extends Frame> extends AbstractComponentUI<Frame> {
    ...
    public void renderComponent(Frame component, FontRenderer fontRenderer) {
        ...
        float fillG = ((ClickGuiColors) ModuleManager.getModuleByName("ClickGuiColors")).fillGreen.getValue();
        float fillB = ((ClickGuiColors) ModuleManager.getModuleByName("ClickGuiColors")).fillBlue.getValue();
     ...
     */
       // glColor4f(.17f,.17f,.18f,.9f);
       // RenderHelper.drawOutlinedRoundedRectangle(0,0,component.getWidth(),component.getHeight(), 6f, 0.59f,0.05f,0.11f,component.getOpacity(),1.5f);
            glColor4f(lineR, lineG, lineB, .6f);
            RenderHelper.drawOutlinedRoundedRectangle(0, 0, component.getWidth(), component.getHeight(), 5f, fillR, fillG, fillB, component.getOpacity(), 1.5f);
