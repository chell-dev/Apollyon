...
public class RootColorizedCheckButtonUI extends RootCheckButtonUI<ColorizedCheckButton> {
    ...
    public void renderComponent(CheckButton component, FontRenderer aa) {
        ...
        glColor4f(lineR, backgroundColour.getGreen()/255f, backgroundColour.getBlue()/255f, component.getOpacity());
        if (component.isHovered() || component.isPressed()){
            glColor4f(lineR, backgroundColourHover.getGreen()/255f, backgroundColourHover.getBlue()/255f, component.getOpacity());
        }
